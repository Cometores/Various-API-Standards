...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Testing.API.DataAccess.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Testing.API.DataAccess.Entities.ExternalEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Testing.API.DataAccess.Entities.InternalEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CourseInternalEmployee", b =>
                {
                    b.HasOne("Testing.API.DataAccess.Entities.Course", null)
                        .WithMany()
                        .HasForeignKey("AttendedCoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Testing.API.DataAccess.Entities.InternalEmployee", null)
                        .WithMany()
