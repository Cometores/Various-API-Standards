...
namespace Restful.API.Migrations
{
    ...
    [Migration("20260211221908_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Restful.API.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Restful.API.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Restful.API.Entities.Course", b =>
                {
                    b.HasOne("Restful.API.Entities.Author", "Author")
                        .WithMany("Courses")
