...
using Restful.API.ResourceParameters;
...
public class AuthorsController : ControllerBase
{
        ...
        ProblemDetailsFactory problemDerailsFactory)
    {
        ...
        _problemDerailsFactory =
            problemDerailsFactory ?? throw new ArgumentNullException(nameof(problemDerailsFactory));
    }
