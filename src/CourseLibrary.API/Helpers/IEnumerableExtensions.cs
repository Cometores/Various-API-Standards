...
public static class IEnumerableExtensions
{
    public static IEnumerable<ExpandoObject> ShapeData<TSource>(this IEnumerable<TSource> source, string? fields)
    {
        ...
        // so rather than doing it for each object in the list, we do it once
        // and reuse the results. After all, part of the reflection is on type of the object (TSource),
        // not the instance
        ...
        else
        {
            ...
            foreach (var field in fieldsAfterSplit)
            {
                ...
                // we need to include public and instance, b/c specifying a binding flag overwrites
