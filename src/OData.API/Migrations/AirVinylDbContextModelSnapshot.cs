...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OData.API.Entities.Person", b =>
                {
            ...
            modelBuilder.Entity("OData.API.Entities.PressingDetail", b =>
                {
            ...
            modelBuilder.Entity("OData.API.Entities.Rating", b =>
                {
            ...
            modelBuilder.Entity("OData.API.Entities.RecordStore", b =>
                {
                    b.Property<int>("RecordStoreId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OData.API.Entities.VinylRecord", b =>
                {
            ...
            modelBuilder.Entity("OData.API.Entities.SpecializedRecordStore", b =>
                {
                    b.HasBaseType("OData.API.Entities.RecordStore");
            ...
            modelBuilder.Entity("OData.API.Entities.Rating", b =>
                {
                    b.HasOne("OData.API.Entities.Person", "RatedBy")
                        .WithMany()
                        .HasForeignKey("RatedByPersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OData.API.Entities.RecordStore", null)
                        .WithMany("Ratings")
            ...
            modelBuilder.Entity("OData.API.Entities.RecordStore", b =>
                {
                    b.OwnsOne("OData.API.Entities.Address", "StoreAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("OData.API.Entities.VinylRecord", b =>
                {
                    b.HasOne("OData.API.Entities.Person", "Person")
                        .WithMany("VinylRecords")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OData.API.Entities.PressingDetail", "PressingDetail")
                        .WithMany()
